...
/**
 * Флаг установленный поверх бомбы.
 *
 * @since 0.1
 */
public class FlagOnBomb implements Cell {
    private final BoardCoordinate coordinate;

    public FlagOnBomb(final BoardCoordinate coordinate) {
    ...
    public EventList setFlag(final Board board) {
        board.setType(this.coordinate, CellType.UN_OPENED_BOMB);
    ...
    public boolean equals(final Object o) {
        ...
        final FlagOnBomb bomb = (FlagOnBomb) o;
